# sales-portfolio — 글로벌영업 Sales Portfolio

정적 웹앱(빌드 없음, `index.html` 하나가 사이트 전체). 제품믹스·분기 포트폴리오.

- 라이브: https://wt-management.github.io/sales-portfolio/
- 데이터는 Supabase(`cons_cache`)에 있다.
